...
PostgreSQL будет доступен на порту `5432` (логин/пароль: `postgres/postgres`, БД: `org_api`). При старте контейнера `api` автоматически выполняются миграции Alembic.
